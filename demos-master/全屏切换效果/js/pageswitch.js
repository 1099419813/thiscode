...
(function($){
    ...
    //定义私有方法(一般以下划线开头)
    /**
     * explain：获取浏览器的前缀(判断元素样式中是否有transition属性)
     * param：dom元素
     * return：boolean
     * */
	...
	var PageSwitch = (function(){
		...
		PageSwitch.prototype = {
			/*explain：初始化插件（初始化dom结构，布局，分页及绑定事件）*/
			init : function(){
				var me = this;
				//dom结构初始化
	...
	$.fn.PageSwitch = function(options){
		return this.each(function(){//实现链式调用
			var me = $(this),
				instance = me.data("PageSwitch");//保存插件的实例
	...
	$.fn.PageSwitch.defaults = {
		selectors : {//用来存放插件的基本元素
			sections : ".sections",//分屏的容器的class
			section : ".section",//分屏各自的class
			page : ".pages",//分页的class
